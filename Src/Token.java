public class Token {
	...
	public static final Token interfaceTok = new Token(TokenType.Interface, "interface");
	public static final Token classTok = new Token(TokenType.Class, "class");
	public static final Token periodTok = new Token(TokenType.Period, ".");	
